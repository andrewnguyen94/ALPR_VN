...
local_layer parse_local(list *option, size_params params){
    int n = option_find_int(option, "filters",1);
    int size = option_find_int(option, "size",1);
    int stride = option_find_int(option, "stride", 1);
    int pad = option_find_int(option, "pad",0);
    char *activation_s = option_find_str(option, "activation", "logistic");
...
convolutional_layer parse_convolutional(list* options, size_params params){
    ...
    convolutional_layer layer = make_convolutional_layer(batch,h,w,c,n,size,
            stride,padding,activation, batch_normalize, binary, xnor,
            params.net.adam);
