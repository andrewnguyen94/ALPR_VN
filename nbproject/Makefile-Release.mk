...
${OBJECTDIR}/activation_layer.o: activation_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/activation_layer.o activation_layer.c

${OBJECTDIR}/activations.o: activations.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/activations.o activations.c

${OBJECTDIR}/avgpool_layer.o: avgpool_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/avgpool_layer.o avgpool_layer.c

${OBJECTDIR}/batchnorm_layer.o: batchnorm_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/batchnorm_layer.o batchnorm_layer.c

${OBJECTDIR}/blas.o: blas.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/blas.o blas.c

${OBJECTDIR}/box.o: box.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/box.o box.c

${OBJECTDIR}/col2im.o: col2im.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/col2im.o col2im.c

${OBJECTDIR}/connected_layer.o: connected_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/connected_layer.o connected_layer.c

${OBJECTDIR}/convolutional_layer.o: convolutional_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/convolutional_layer.o convolutional_layer.c

${OBJECTDIR}/cost_layer.o: cost_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cost_layer.o cost_layer.c

${OBJECTDIR}/crop_layer.o: crop_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/crop_layer.o crop_layer.c

${OBJECTDIR}/cuda.o: cuda.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cuda.o cuda.c
...
${OBJECTDIR}/deconvolutional_layer.o: deconvolutional_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deconvolutional_layer.o deconvolutional_layer.c

${OBJECTDIR}/demo.o: demo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/demo.o demo.c

${OBJECTDIR}/detection_layer.o: detection_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/detection_layer.o detection_layer.c

${OBJECTDIR}/dropout_layer.o: dropout_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dropout_layer.o dropout_layer.c

${OBJECTDIR}/gemm.o: gemm.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gemm.o gemm.c

${OBJECTDIR}/gru_layer.o: gru_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gru_layer.o gru_layer.c

${OBJECTDIR}/im2col.o: im2col.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/im2col.o im2col.c

${OBJECTDIR}/image.o: image.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/image.o image.c

${OBJECTDIR}/layer.o: layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/layer.o layer.c
...
${OBJECTDIR}/local_layer.o: local_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/local_layer.o local_layer.c
...
${OBJECTDIR}/maxpool_layer.o: maxpool_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/maxpool_layer.o maxpool_layer.c
...
${OBJECTDIR}/normalization_layer.o: normalization_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/normalization_layer.o normalization_layer.c

${OBJECTDIR}/option_list.o: option_list.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/option_list.o option_list.c
...
${OBJECTDIR}/rcnn_layer.o: rcnn_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rcnn_layer.o rcnn_layer.c

${OBJECTDIR}/region_layer.o: region_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/region_layer.o region_layer.c

${OBJECTDIR}/reorg_layer.o: reorg_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/reorg_layer.o reorg_layer.c

${OBJECTDIR}/rnn_layer.o: rnn_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rnn_layer.o rnn_layer.c

${OBJECTDIR}/route_layer.o: route_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/route_layer.o route_layer.c

${OBJECTDIR}/shortcut_layer.o: shortcut_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shortcut_layer.o shortcut_layer.c

${OBJECTDIR}/softmax_layer.o: softmax_layer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/softmax_layer.o softmax_layer.c
...
${OBJECTDIR}/yolo.o: yolo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/yolo.o yolo.c
